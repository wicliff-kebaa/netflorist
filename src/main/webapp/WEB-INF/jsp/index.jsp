                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Net-Florist</strong> Login &amp; Register Forms</h1>
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="" method="post" class="registration-form">
				                        ...
				                        <div class="form-group">
				                         ...
				                         <div class="form-group">
				                        	<label class="sr-only" for="form-cellphone">Cellphone Number</label>
				                        	<input type="text" name="form-cellphone" placeholder="Cellphone..." class="form-cellphone form-control" id="form-cellphone">
				                        </div>
